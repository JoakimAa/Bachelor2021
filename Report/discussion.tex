...
As mentioned in chapter 5 and seen in~\ref{fig:scuffedmatchresult}, the de-skew being reliant on CNN prediction has
consequences to the rest of the pipeline.
...
result as~\ref{fig:scuffedmatchresult}.
