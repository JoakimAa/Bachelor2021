...
\begin{figure}[h]
    \center{\includegraphics[width=0.65 \textwidth]{Images/maxpooling2D}}
...
\begin{figure}[h]
    \center{\includegraphics[width=0.65 \textwidth]{Images/CNN_model}}
    \caption{CNN model}
    \label{fig:figure4}
...
\begin{figure}[h]
    \center{\includegraphics[width=0.65 \textwidth]{Images/CNN_compile}}
