...
Google is the one of the industry leaders, but they are also the most expensive API to use.
...
\begin{figure}[h]
    \center{\includegraphics[width=0.4\textwidth]{Images/spacy-features}}
