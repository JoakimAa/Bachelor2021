...
On further inspection, we can see that the date found in \figurename{~\ref{fig:dateocr}} does not match the date in
the image.
...
We will talk in debt about the price extraction in \ref{sec:price-extraction-with-spacy}.
