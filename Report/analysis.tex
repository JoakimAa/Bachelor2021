...
The API also has a lot of features in their beta version which is not shown in figure~\ref{fig:Google cloud API prices}
\clearpage
...
As you can see in figure~\ref{fig:label image}, you will get labels that describes the words.
