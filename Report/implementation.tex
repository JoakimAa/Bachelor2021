...
We also add b[11] to an array, because these are the words that the OCR finds.\ref{fig:figure4.8}
...
The first match that comes up is the one we use.\ref{fig:figure4.9}